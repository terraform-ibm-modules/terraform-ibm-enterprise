...
<ul>
  ...
  <li><a href="./modules">Submodules</a>
    <ul>
      <li><a href="./modules/account_invite">account_invite</a></li>
      <li><a href="./modules/dynamic_values">dynamic_values</a></li>
      <li><a href="./modules/enterprise_hierarchy">enterprise_hierarchy</a></li>
    </ul>
  </li>
  ...
  <li><a href="./solutions">Deployable Architectures</a>
    <ul>
      <li><a href="./solutions/fully-configurable">Cloud automation for IBM Cloud Enterprise (Fully configurable)</a></li>
    </ul>
  </li>
